 ...
 // Datos de ejemplo (simulando productos de diferentes categorías)
      const products = [
        ...
        },
        {
          ...
          description: "625mL - Electrolit- suero hidratante sabor naranja-mandarina.",
          price: 4500,
          unit: "Botella 625mL",
          category: "jugos",
...
function renderProducts(productsToRender) {
  ...
  document.getElementById('results-count').textContent = productsToRender.length;
  ...
  productsToRender.forEach(product => {
    ...
    productList.appendChild(productCard);
      ...
      function openProductModal(product) {
        ...
        document.getElementById('modal-product-stock').textContent = `En stock (${product.stock} unidades)`;
...
// Simulación de carga de productos al inicio